...
sim = SimulationParams(
    ...
    N_min=0,
    T_σ=T_σ, Λ_σ=Λ_σ,
    λ_max=0, #M1 !!! 1/t to help fix error saturation and a bit of an alchemical nudge to help high N insertion will this even work?
    r_cut_σ=3.,
    L_σ = 8.0,
...
μstate = load_microstate_jld2("/Users/mckinleypaul/Documents/montecarlo/segc_wl/examples/N350_L8_T1.2/1overt/M1/microstate_checkpoint.jld2")
wl = load_wanglandau_jld2("/Users/mckinleypaul/Documents/montecarlo/segc_wl/examples/N350_L8_T1.2/1overt/M1/wl_checkpoint.jld2")
